...
export function Testimonials({
    title = "What our communities <br /> say about <span class='text-[#63C14B]'>Yosh Recycle</span>",
        ...
        <section className="py-32 px-[5vw] bg-neutral-50 text-black">
            <div className="max-w-[1800px] mx-auto">
                <div className="text-center mb-20">
                    <span className="text-[#63C14B] font-bold uppercase tracking-widest text-xs mb-4 block">{subtitle}</span>
                    <h2 className="text-4xl md:text-6xl font-bold tracking-tighter uppercase leading-[0.9]" dangerouslySetInnerHTML={{ __html: title }}>
                    </h2>
                </div>
