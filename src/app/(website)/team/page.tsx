        ...
        <main className="min-h-screen bg-white text-black">
            ...
            <div className="pt-40 pb-20 px-[5vw] border-b border-neutral-100">
                <div className="max-w-[1800px] mx-auto">
                    <span className="text-[#63C14B] font-bold tracking-widest uppercase text-sm mb-4 block">Our People</span>
                    <h1 className="text-[10vw] leading-[0.85] font-bold tracking-tighter uppercase mb-12">
                        The Minds <br />
                        <span className="text-transparent bg-clip-text bg-gradient-to-r from-neutral-800 to-neutral-400">Behind Yosh</span>
                    </h1>

                    <div className="flex flex-col md:flex-row justify-between items-end gap-8">
                        <p className="text-xl md:text-2xl text-neutral-600 max-w-2xl leading-relaxed">
                            We are a collective of environmentalists, engineers, and community leaders driven by a single purpose: to redefine waste in Africa.
                        </p>
                    </div>
                </div>
            </div>
