            ...
            <section className="py-20 px-[5vw] border-b border-neutral-100">
                <div className="max-w-[1800px] mx-auto">
                    <h1 className="text-6xl md:text-8xl font-bold uppercase tracking-tighter mb-8 leading-[0.9]">
                        {data?.heroTitlePrefix || "We Are"} <br />
                        <span className="text-[#63C14B]">{data?.heroTitleHighlight || "Yosh Recycle"}</span>
                    </h1>
                    ...
                    <div className="space-y-12">
                        <div>
                            <h2 className="text-4xl md:text-5xl font-bold uppercase tracking-tight mb-6 text-black">
                                {data?.challengeTitlePrefix || "The Urban"} <br />
                                <span className="text-red-500">{data?.challengeTitleHighlight || "Waste Crisis"}</span>
                            </h2>
                        ...
                        <div>
                            <h2 className="text-4xl md:text-5xl font-bold uppercase tracking-tight mb-6 text-black">
                                {data?.solutionTitlePrefix || "Our"} <span className="text-[#63C14B]">{data?.solutionTitleHighlight || "Solution"}</span>
                            </h2>
